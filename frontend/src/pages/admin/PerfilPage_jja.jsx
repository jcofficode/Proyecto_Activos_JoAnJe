      ...
      <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: 24, alignItems: 'start' }}>
        ...
        <div className="card-jja" style={{ textAlign: 'center' }}>
          <div className="card-body-jja" style={{ padding: 28 }}>
            <div style={{ width: 80, height: 80, borderRadius: 16, background: 'linear-gradient(135deg, var(--color-primario-jja), var(--color-secundario-jja))', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '1.5rem', fontWeight: 800, margin: '0 auto 12px' }}>
              {iniciales}
            </div>
