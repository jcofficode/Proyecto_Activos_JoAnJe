-- ============================================================
-- init_railway.sql — Esquema final completo
-- Ejecútalo en el cliente de tu base de datos Railway.
-- ============================================================
...
-- Índices
CREATE INDEX `idx_activo_estado_jja`         ON `activos_jja`   (`estado_jja`);

CREATE INDEX `idx_prestamo_estado_jja`       ON `prestamos_jja` (`estado_prestamo_jja`);

CREATE INDEX `idx_prestamo_fecha_limite_jja` ON `prestamos_jja` (`fecha_limite_jja`);

CREATE INDEX `idx_prestamo_usuario_jja`      ON `prestamos_jja` (`id_usuario_jja`);

CREATE INDEX `idx_prestamo_activo_jja`       ON `prestamos_jja` (`id_activo_jja`);

CREATE INDEX `idx_historial_prestamo_jja`    ON `historial_prestamos_jja` (`id_prestamo_jja`);

CREATE INDEX `idx_notif_usuario_leida_jja`   ON `notificaciones_jja` (`id_usuario_jja`, `leida_jja`);

CREATE INDEX `idx_lista_negra_usuario_jja`   ON `lista_negra_jja` (`id_usuario_jja`, `activa_jja`);

CREATE INDEX `idx_auditoria_tabla_jja`       ON `auditoria_jja` (`tabla_afectada_jja`);

CREATE INDEX `idx_auditoria_fecha_jja`       ON `auditoria_jja` (`fecha_accion_jja`);

CREATE INDEX `idx_prestamo_usuario_estado_jja` ON `prestamos_jja` (`id_usuario_jja`, `estado_prestamo_jja`);
