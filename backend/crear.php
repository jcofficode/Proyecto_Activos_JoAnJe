...
", "Tabla <strong>solicitudes_devolucion_jja</strong>", $cnt_tablas_jja, $errores_jja);
            ...
            $sps_a_eliminar_jja = [
                ...
                'SP_ELIMINAR_ROL_jja',
                'SP_CREAR_USUARIO_jja',
                'SP_LEER_USUARIOS_jja',
                'SP_LEER_USUARIO_ID_jja',
                'SP_LEER_USUARIO_CEDULA_jja',
                'SP_ACTUALIZAR_USUARIO_jja',
                'SP_ELIMINAR_USUARIO_jja',
                'SP_CAMBIAR_CONTRASENA_jja',
                'SP_ACTUALIZAR_IMAGEN_USUARIO_jja',
                'SP_CREAR_TIPO_ACTIVO_jja',
                'SP_LEER_TIPOS_ACTIVOS_jja',
                'SP_LEER_TIPO_ACTIVO_ID_jja',
                'SP_ACTUALIZAR_TIPO_ACTIVO_jja',
                'SP_ELIMINAR_TIPO_ACTIVO_jja',
                'SP_CREAR_POLITICA_jja',
                'SP_LEER_POLITICAS_jja',
                'SP_LEER_POLITICA_TIPO_jja',
                'SP_ACTUALIZAR_POLITICA_jja',
                'SP_ELIMINAR_POLITICA_jja',
                'SP_CREAR_ACTIVO_jja',
                'SP_LEER_ACTIVOS_jja',
                'SP_LEER_ACTIVO_ID_jja',
                'SP_LEER_ACTIVO_QR_jja',
                'SP_LEER_ACTIVO_NFC_jja',
                'SP_ACTUALIZAR_ACTIVO_jja',
                'SP_ACTUALIZAR_ESTADO_ACTIVO_jja',
                'SP_ELIMINAR_ACTIVO_jja',
                'SP_PUBLICAR_ACTIVO_jja',
                'SP_GUARDAR_IMAGENES_ACTIVO_jja',
                'SP_REGISTRAR_PRESTAMO_jja',
                'SP_REGISTRAR_DEVOLUCION_jja',
                'SP_LEER_PRESTAMOS_jja',
                'SP_LEER_PRESTAMO_ID_jja',
                'SP_LEER_PRESTAMOS_USUARIO_jja',
                'SP_LEER_PRESTAMOS_ACTIVOS_jja',
                'SP_LEER_PRESTAMOS_POR_ACTIVO_jja',
                'SP_LEER_PRESTAMOS_VENCIDOS_jja',
                'SP_MARCAR_PRESTAMO_PERDIDO_jja',
                'SP_ACTUALIZAR_VENCIDOS_jja',
                'SP_CREAR_NOTIFICACION_jja',
                'SP_LEER_NOTIFICACIONES_USUARIO_jja',
                'SP_MARCAR_NOTIFICACION_LEIDA_jja',
                'SP_MARCAR_TODAS_LEIDAS_jja',
                'SP_ELIMINAR_NOTIFICACION_jja',
                'SP_CREAR_SANCION_jja',
                'SP_LEER_SANCIONES_jja',
                'SP_LEER_SANCIONES_USUARIO_jja',
                'SP_LEVANTAR_SANCION_jja',
                'SP_VERIFICAR_SANCION_jja',
                'SP_VERIFICAR_SANCION_DETALLE_jja',
                'SP_AUTO_SANCIONAR_VENCIDOS_jja',
                'SP_LEER_AUDITORIA_jja',
                'SP_LEER_AUDITORIA_TABLA_jja',
                'SP_LEER_AUDITORIA_USUARIO_jja',
                'SP_REGISTRAR_AUDITORIA_jja',
                'SP_INVALIDAR_TOKEN_jja',
                'SP_VERIFICAR_TOKEN_INVALIDO_jja',
                'SP_LIMPIAR_TOKENS_jja',
                'SP_REPORTE_PRESTAMOS_jja',
                'SP_REPORTE_ACTIVOS_MAS_PRESTADOS_jja',
                'SP_REPORTE_USUARIOS_ACTIVOS_jja',
                'SP_REPORTE_TASA_DEVOLUCION_jja',
...
END", "Trigger: TR_HISTORIAL_PRESTAMO_DEVOLUCION_jja (registro automático)", $cnt_triggers_jja, $errores_jja);
            ...
            try {
                ...
                mostrar_jja('err', '❌', 'Error en políticas: ' . $ex_jja->getMessage());
            }
            ...
            try {
                ...
                mostrar_jja('err', '❌', 'Error al crear usuarios demo: ' . $ex_jja->getMessage());
            }

            // ── Carga masiva de activos educativos ──────────────────
            try {
                $activos_seed_jja = [
                    ['Laptop Dell Latitude 5540', 'QR-LAP-001', NULL, 'Laptop', 'Sala de Informática A', 'Laptop Dell Latitude 5540, Intel Core i5, 16GB RAM, 512GB SSD. Uso académico para docentes y estudiantes.'],
                    ['Laptop HP ProBook 450 G10', 'QR-LAP-002', NULL, 'Laptop', 'Sala de Informática B', 'Laptop HP ProBook 450 G10, Intel Core i7, 16GB RAM, 256GB SSD. Asignada a laboratorio de programación.'],
                    ['Videobeam Epson PowerLite X49', 'QR-VID-001', NULL, 'Videobeam', 'Almacén Audiovisual', 'Proyector Epson PowerLite X49, 3600 lúmenes, XGA. Para presentaciones en aulas y auditorios.'],
                    ['Videobeam ViewSonic PA503S', 'QR-VID-002', NULL, 'Videobeam', 'Almacén Audiovisual', 'Proyector ViewSonic PA503S, 3800 lúmenes, SVGA. Uso en conferencias y defensas de tesis.'],
                    ['Tablet Samsung Galaxy Tab A9', 'QR-TAB-001', NULL, 'Tablet', 'Biblioteca Central', 'Tablet Samsung Galaxy Tab A9, 64GB, WiFi. Disponible para consulta digital en biblioteca.'],
                    ['Tablet Lenovo Tab M10 Plus', 'QR-TAB-002', NULL, 'Tablet', 'Laboratorio de Idiomas', 'Tablet Lenovo Tab M10 Plus, 128GB. Herramienta de apoyo para clases de idiomas.'],
                    ['Cámara Canon EOS Rebel T7', 'QR-CAM-001', NULL, 'Cámara', 'Departamento de Comunicación', 'Cámara réflex Canon EOS Rebel T7, 24.1 MP, lente 18-55mm. Para cobertura de eventos institucionales.'],
                    ['Cámara Sony Alpha a6400', 'QR-CAM-002', NULL, 'Cámara', 'Departamento de Comunicación', 'Cámara mirrorless Sony a6400, 24.2 MP, video 4K. Producción audiovisual académica.'],
                    ['Computadora HP ProDesk 400 G7', 'QR-COM-001', NULL, 'Computadora', 'Laboratorio de Cómputo 1', 'PC de escritorio HP ProDesk 400 G7, Intel Core i5, 8GB RAM, 1TB HDD. Estación de trabajo estudiantil.'],
                    ['Computadora Lenovo ThinkCentre M70q', 'QR-COM-002', NULL, 'Computadora', 'Laboratorio de Cómputo 2', 'Mini PC Lenovo ThinkCentre M70q, Intel Core i3, 8GB RAM, 256GB SSD. Equipo compacto para aulas.'],
                    ['Proyector Multimedia Epson EB-992F', 'QR-PRO-001', NULL, 'Proyector', 'Auditorio Principal', 'Proyector Epson EB-992F, Full HD, 4000 lúmenes, WiFi integrado. Instalado en auditorio principal.'],
                    ['Pendrive Kingston DataTraveler 64GB', 'QR-PEN-001', NULL, 'Pendrive', 'Recepción Biblioteca', 'Pendrive Kingston DataTraveler Exodia 64GB USB 3.2. Préstamo rápido para transferencia de archivos.'],
                    ['Pendrive SanDisk Ultra 128GB', 'QR-PEN-002', NULL, 'Pendrive', 'Recepción Biblioteca', 'Pendrive SanDisk Ultra 128GB USB 3.0. Uso académico para respaldo de proyectos.'],
                ...
                mostrar_jja('err', '❌', 'Error al insertar activos educativos: ' . $ex_jja->getMessage());
            }
            ...
            <div class="resumen-wrapper">
                <div class="resumen-header">
                    ...
                    <div>
                        <div class="resumen-header-text">
                            ...
                            <small>Base de datos: <code>gestion_activos_jja</code> · JoAnJe Coders &copy;
                                <?= date('Y') ?></small>
                        </div>
                    </div>
                </div>
                ...
                <div class="resumen-db">
                    Motor: <code>InnoDB</code> &nbsp;·&nbsp; Charset: <code>utf8mb4_unicode_ci</code> &nbsp;·&nbsp; Zona
                    horaria: <code>-04:00</code>
                </div>
